...
install.completion = function (opts, cb) {
  ...
  // install can complete to a folder with a app.json, or any package.
  ...
  if (/\//.test(opts.partialWord)) {
    ...
    // is a folder containing a app.json file.  If that is not the
...
Installer.prototype.normalizeCurrentTree = function (cb) {
  ...
  // If the user didn't have a app.json then fill in deps with what was on disk
...
Installer.prototype.printInstalledForHuman = function (diffs, auditResult) {
  ...
  // Values of `author` and elements of `contributors` in `app.json`
